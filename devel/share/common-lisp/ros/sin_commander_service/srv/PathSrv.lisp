...
(cl:defmethod cl:initialize-instance :after ((m <PathSrv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PathSrv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sin_commander_service-srv:<PathSrv-request> is deprecated: use sin_commander_service-srv:PathSrv-request instead.")))

(cl:ensure-generic-function 'nav_path-val :lambda-list '(m))
(cl:defmethod nav_path-val ((m <PathSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sin_commander_service-srv:nav_path-val is deprecated.  Use sin_commander_service-srv:nav_path instead.")
  (nav_path m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PathSrv-request>)))
  ...
  "sin_commander_service/PathSrvRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PathSrv-request)))
  "Returns string type for a service object of type 'PathSrv-request"
  "sin_commander_service/PathSrvRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <PathSrv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PathSrv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sin_commander_service-srv:<PathSrv-response> is deprecated: use sin_commander_service-srv:PathSrv-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PathSrv-response>)))
  ...
  "sin_commander_service/PathSrvResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PathSrv-response)))
  "Returns string type for a service object of type 'PathSrv-response"
  "sin_commander_service/PathSrvResponse")
